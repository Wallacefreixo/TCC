...
echo "Voc&ecirc; est&aacute; vendo o hist&oacute;rico de exames solicitados do Receituário: ";
echo $aux;
echo "<br>";
echo "<br>";
...
echo "<br>";
$sql=sqlsrv_query($conn, "SELECT Exame.Id, Exame.Nome FROM  Receituario INNER JOIN HistoricoExame ON Receituario.Id = HistoricoExame.IdReceituario INNER JOIN Exame ON HistoricoExame.IdExame = Exame.Id Where HistoricoExame.IdReceituario ='$aux';");
